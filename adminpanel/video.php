...
if (isset($_POST['simpan'])) {
    ...
    $queryTambah = mysqli_query($conn, "INSERT INTO video(link, judul) VALUES('$link', '$judul')");
        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div>
                    ...
                    <input type="text" required id="link" name="link" class="form-control" autocomplete="off">
                </div>
                <div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        if($queryJumlah==0){
                            ?>
                            <tr>
                                <td colspan="6" class="text-center">Data Video Tidak Tersedia</td>
                            </tr>
                            <?php
                        } else {
                            $jumlah = 0;
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <a href="video-detail.php?p=<?php echo $data['id_video']; ?>" class="btn btn-info"><i class="fas fa-search"></i></a>
                                    </td>
                                </tr>
                                <?php
                            }
