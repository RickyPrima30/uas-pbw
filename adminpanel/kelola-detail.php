...
<br><br><br>
    ...
    <div class="col-12 col-md-6">
        <form action="" method="POST">
            ...
            <input type="email" id="email" required class="form-control" name="email" value="<?php echo $data['email']; ?>"> 
            </div>
            <div>
            <label for="password">Password</label>
            <input type="password" name="email" id="email" class="form-control" value="<?php echo $data['password']; ?>">
            </div>
        ...
        if(isset($_POST['editBtn'])){
            ...
            if($data['name']==$name){
                ...
                $query = mysqli_query($conn, "SELECT * FROM user_form WHERE name='$name' ");
                ...
                if($jumlahData > 0){
                    ...
                    $querySimpan = mysqli_query($conn, "UPDATE user_form SET name='$name', email='$email', password='$password' WHERE id=$id ");
                    if($querySimpan){
                        ?>
                        <div class="alert alert-secondary mt-3" role="alert">
        ...
        if(isset($_POST['deleteBtn'])){
            ...
            $queryDelete = mysqli_query($conn, "DELETE FROM user_form WHERE id=$id");
            ...
            if ($queryDelete){
                ...
                <meta http-equiv="refresh" content="2; url=kelola.php"/>
                <?php
            }else{
                        echo mysqli_error($conn);
                    }
