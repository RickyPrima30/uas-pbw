...
if (isset($_POST['simpan_akun'])) {
  ...
  $user_type = $_POST['user_type'];
    ...
    if ($insert) {
?>
    <meta http-equiv="refresh" content="0; url=kelola.php"/>
<?php
    } else {
        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div>
                    ...
                    <input type="text" required id="name" name="name" class="form-control" autocomplete="off">
                </div>
                <div>
                ...
                <div>
                    <button type="submit" class="btn btn-success" name="simpan_akun">Simpan</button>
                </div>
            </form>
        </div>
                        ...
                        if($queryJumlah==0){
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <a href="kelola-detail.php?p=<?php echo $data['id']; ?>" class="btn btn-info"><i class="fas fa-search"></i></a>
                                    </td>
                                </tr>
                                <?php
                            }
