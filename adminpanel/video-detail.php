...
<br><br><br>
    ...
    <div class="col-12 col-md-6">
        <form action="" method="POST">
            ...
            <textarea name="judul" id="judul" cols="30" rows="10" class="form-control"><?php echo $data['judul'] ?></textarea> 
            </div>
        ...
        if(isset($_POST['editBtn'])){
            ...
            if($data['name']==$name){
                ...
                $query = mysqli_query($conn, "SELECT * FROM video WHERE name='$link' ");
                ...
                if($jumlahData > 0){
                    ...
                    $querySimpan = mysqli_query($conn, "UPDATE user_form SET name='$link', judul='$judul' WHERE id_video=$id ");
                    if($querySimpan){
                        ?>
                        <div class="alert alert-secondary mt-3" role="alert">
                            Video Berhasil di UPDATE
                        </div>

                        <meta http-equiv="refresh" content="2; url=video.php"/>
                        <?php
                    }
                    else{
        ...
        if(isset($_POST['deleteBtn'])){
            ...
            $queryDelete = mysqli_query($conn, "DELETE FROM video WHERE id_video=$id");
